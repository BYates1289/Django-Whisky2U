...
urlpatterns = [
    ...
    path('deliver/address/<pk>/',
         CustomerAddressDetials.as_view(), name='address_details'),
    path('change_delivery/<pk>/', changeStatus.as_view(), name='deliver_done'),
    path('create/delivery/<id>/<pk>/<quan>/<order_type>/',
         CreateDelivery, name='create_delivery'),
