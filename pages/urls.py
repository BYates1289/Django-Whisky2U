...
urlpatterns = [
    ...
    path('shop/price/<int:fromm>/<int:to>/',
         ProductPriceRange.as_view(), name='price_range'),
    path('shop/age/<int:fromm>/<int:to>/',
         ProductAgeRange.as_view(), name='age_range'),
    ...
    path('dashboard/<p_type>/', CustomerDashboard.as_view(),
         name='customer_dashboard'),
    path('dashboard/canceled/<sub>/',
         CustomerCanceledSubscription.as_view(), name='cancel_subscription'),

    path('category/<slug:category>/',
         SingleCategoryView.as_view(), name='category'),
    path('cancel/', CancelView.as_view(), name='cancel'),
    path('terms', TermsView.as_view(), name='terms'),

    path('account/address/', CustomerAddressView.as_view(), name='address'),
    path('checkout/single/address/',
         CheckoutSingleAddressView.as_view(), name='single_address'),
    path('checkout/monthly/address/',
         CheckoutMonthlyAddressView.as_view(), name='monthly_address'),
